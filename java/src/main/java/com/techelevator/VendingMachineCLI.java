...
public class VendingMachineCLI {
    ...
    private static final String[] SECRET_MENU_OPTIONS = {MAIN_MENU_OPTION_SALES_REPORT};
    ...
    private Menu menu;
    private List<Item> itemList = new ArrayList<>();// created to make list of all the items, of the abstract class
    ...
    }// end of purchase options menu mthod
    ...
    public void loadData() {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                String itemType = lineArr[3]; //could potentially need to make this a private variable in the classes...

                //put the item obj inside the if.
    ...
    public void finishTransaction(){
        ...
        int work= changeCorrected.intValue();// not sure if we need this.
        ...
        // cant get it to show whole numbers but w.e
